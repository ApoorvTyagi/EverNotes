                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Welcome 
                            <small><?php echo $_SESSION['name']; $branch=$_SESSION['course']; ?></small>
                        </h1>
...
$query = "SELECT * FROM uploads where file_uploaded_to='$branch' ORDER BY file_uploaded_on DESC";
...
?>
 ...
 <?php
    ...
    if (isset($_GET['del'])) {
        ...
        if (mysqli_affected_rows($conn) > 0) {
            echo "<script>alert('Notes approved successfully');
            window.location.href='index.php';</script>";
        }
        else {
         echo "<script>alert('error occured.try again!');</script>";   
...
<?php 
 ...
 <h3 class="page-header">
                            <center> <marquee width = 70% ><font color="green" >View And Upload <?php echo $_SESSION['course']; ?> Notes Here.</font><font color="brown"></font></marquee></center>
                        </h3>
...
<?php 
 ...
 <h3 class="page-header">
                            <center> <marquee width = 70% ><font color="green" >View And Download Your <?php echo $_SESSION['course']; ?> Notes Here.</font><font color="brown"></font></marquee></center>
                        </h3>
