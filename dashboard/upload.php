...
<div id="wrapper">
	...
	<div class="form-group">
		<label for="post_tags">Notes Tags</label>
		<input type="text" name="tags" class="form-control" placeholder="Eg: Php, Learn Php etc.." ">
	</div>

	<div class="form-group">
		<label for="post_content">Description about your note</label>
